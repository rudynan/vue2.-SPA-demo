  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <counter @onchange="onParamChange('buyNum',$event)"></counter>
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <selection :selections="buyTypes" @onchange="onParamChange('buyType',$event)"></selection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
        ...
        <multiplyChooserser :selections="periodList" @onchange="onParamChange('period',$event)"></multiplyChooserser>
        <div class="sales-board-line-right">
      ...
      <div class="sales-board-line">
        ...
        <chooser :selections="versionList" @onchange="onParamChange('versions',$event)"></chooser>
        <div class="sales-board-line-right">
    ...
    <mydialog :isShow='isShowPayDialog' @on-close="hidePayDialog">
